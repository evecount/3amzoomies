        ...
        <div className="flex flex-col min-h-screen bg-background text-foreground">
            ...
            <main className="flex-grow container mx-auto px-4 py-12 md:py-16">
                <div className="text-center mb-12 px-4">
                    <p className="text-primary font-semibold text-lg tracking-widest uppercase">Official Gear</p>
                    <h1 className="font-semibold text-5xl md:text-6xl uppercase tracking-wider">Merchandise</h1>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    <Card className="bg-card/50 overflow-hidden flex flex-col">
                        ...
                        <CardHeader>
                            <CardTitle className="font-semibold text-3xl uppercase">"The Observer" Official Tee</CardTitle>
                    ...
                    <Card className="bg-card/50 overflow-hidden flex flex-col">
                        ...
                        <CardHeader>
                            <CardTitle className="font-semibold text-3xl uppercase">"Midnight Murmurs" Vinyl</CardTitle>
                    ...
                    <Card className="bg-card/50 overflow-hidden flex flex-col">
                        ...
                        <CardHeader>
                            <CardTitle className="font-semibold text-3xl uppercase">"The Judgmental Mug"</CardTitle>
                    ...
                    <Card className="bg-card/50 overflow-hidden flex flex-col">
                        ...
                        <CardHeader>
                            <CardTitle className="font-semibold text-3xl uppercase">"The Usurped Pillow Case"</CardTitle>
