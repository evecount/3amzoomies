...
export function MerchandiseSection() {
    ...
    const handleOpenWaitlist = (productTitle: string) => {
                ...
                {products.map((product) => {
                    ...
                    <Card key={product.id} className="bg-card/50 overflow-hidden flex flex-col">
                        ...
                        <CardFooter className="p-4 pt-0">
                           <Button 
                                className="w-full bg-accent hover:bg-accent/90 text-accent-foreground uppercase"
                                onClick={() => handleOpenWaitlist(product.title)}
                            >
                                Join The Waitlist
                            </Button>
                        </CardFooter>
