      ...
      <main className="flex-grow container mx-auto px-4 py-12 md:py-16">
        ...
        <Card className="bg-stone-50 text-stone-900 shadow-2xl">
            <CardContent className="p-0">
                {bannerImage && (
                    <div className="relative w-full aspect-video rounded-t-lg overflow-hidden flex items-center justify-center bg-stone-200 text-stone-500">
                        <Image 
                            src={bannerImage.src}
                ...
                <div className="grid lg:grid-cols-3 gap-12 items-start p-6 md:p-12">
                    <article className="prose prose-stone prose-lg max-w-none prose-a:text-primary hover:prose-a:text-primary/80 leading-relaxed space-y-6 lg:col-span-2">
                        <p className="lead">
