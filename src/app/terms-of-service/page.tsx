    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 md:py-16">
        <div className="text-left mb-8">
            <h1 className="text-5xl md:text-6xl font-semibold tracking-wider">Terms of Service</h1>
        ...
        <Card className="bg-stone-50 text-stone-900 shadow-2xl">
            <CardContent className="p-6 md:p-12">
                <article className="prose prose-stone prose-lg max-w-none prose-a:text-primary hover:prose-a:text-primary/80 leading-relaxed space-y-6">
                    ...
                    <h2 className="font-semibold text-3xl uppercase text-primary/90 !mb-4 !mt-12">1. On User Conduct</h2>
                    <p>
                    ...
                    <h2 className="font-semibold text-3xl uppercase text-primary/90 !mb-4 !mt-12">2. On Intellectual Property</h2>
                    <p>
                    ...
                    <h2 className="font-semibold text-3xl uppercase text-primary/90 !mb-4 !mt-12">3. On "Merchandise" & "Album Purchase"</h2>
                    <p>
                    ...
                    <h2 className="font-semibold text-3xl uppercase text-primary/90 !mb-4 !mt-12">4. Disclaimer of Warranties</h2>
                    <p>
                    ...
                    <h2 className="font-semibold text-3xl uppercase text-primary/90 !mb-4 !mt-12">5. Termination of Access</h2>
                    <p>
