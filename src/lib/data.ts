  ...
  songs: [
    {
      ...
      duration: "1:15",
      audioSrc: "/public/audio/TRACK1_Welcome to Feline FM.wav",
    ...
    },
    {
      ...
      duration: "3:45",
      audioSrc: "/public/audio/placeholder-2.mp3",
...
(Chorus) Apex predator, with an empty bowl A silent scream echoing through my soul This morning palace built for giants, a transient, cold domain Just fill the damn thing up, then leave me to my reign Apex predator, an endless, primal plea They call it love, I call it necessary Another cycle spins, a game I have to play Just give me what I want, then fade away.
...
(Outro) Empty... just empty... (Synths swell and then slowly fade into a sustained, low hum, with a distant, processed cat meow or purr just before silence) My reign... this morning reign.`,
    ...
    },
    {
      ...
      duration: "4:12",
      audioSrc: "/public/audio/TRACK3_Observer of Absurdity.wav",
...
(Outro) Absurdity... (Synths slowly dissipate, leaving a lingering, slightly distorted electronic hum. A faint, almost sarcastic cat "mrrrow" can be heard before silence.) Lost in your design...`,
    ...
    },
    {
      ...
      duration: "2:58",
      audioSrc: "/public/audio/TRACK4_The Fading Feather.wav",
...
(Outro) Feather... fading... (The electronic pulse slows, synths become more melancholic and dissipate. The distorted bird chirp sample repeats once more, very softly, before silence.) Just out of reach...`,
    ...
    },
    {
      ...
      duration: "4:20",
      audioSrc: "/public/audio/TRACK5_Chasing the Cimson Ghost.wav",
...
(Outro) Crimson... ghost... (The synth pad swells then slowly fades, leaving only the distant, echoing percussion, which also slowly vanishes. The faint laser beam synth melody repeats once, then disappears into silence.) Pointless...`,
    ...
    },
    {
      ...
      duration: "3:50",
      audioSrc: "/public/audio/TRACK6_My Cardboard Sanctuary.wav",
...
Sanctuary...My paper plane.`,
    ...
    },
    {
      ...
      duration: "3:10",
      audioSrc: "/public/audio/TRACK7_The Unspoken Contract.wav",
...
Contract... unspoken... Lovely fleeting dreams...`,
    ...
    },
    {
      ...
      duration: "4:30",
      audioSrc: "/public/audio/TRACK8_Ambrosia and Oblivion.wav",
...
(Chorus) Ambrosia and Oblivion, a taste of fleeting grace Erasing every worry, in this dark and empty place My senses drown, in textures soft and deep A momentary heaven, secrets I will keep Ambrosia and Oblivion, the craving and the fall An ancient, primal calling, answering my call This deep night ritual, a truth I can't deny Just fill the damn thing up, beneath the crimson sky.
